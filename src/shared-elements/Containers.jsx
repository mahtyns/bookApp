            ...
            {changeContainers
                ? (
                    <div className="containersLeft">
                        <Texts
                            textContent={props.titleSectionLeft}
                            textSize={'xlarge'}
                            fontStyle={'decorFont'}/> {props.containerLeft_Content}
                    </div>
                )
                : null}
            <div className="containersRight">
                <Texts
                    textContent={props.titleSectionRight}
                    textSize={'xlarge'}
                    fontStyle={'decorFont'}/> {props.containerRight_Content}
            </div>
        </div>
    )
}
